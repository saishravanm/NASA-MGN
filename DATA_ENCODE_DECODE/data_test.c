...
int main(int argc, char** argv) {
	...
	printf("Synchronization & Error Correction Data (Currently Unused:\n"
	       ...
	       data.frame, data.bch1, data.bch2, data.format_f, data.protocol_f, cc.code, cc.digits, data.pc, data.id_data.init_buffer, coord.ns, coord.lat_deg, coord.ew, coord.long_deg, coord.lat_delta_min, coord.lat_delta_sec, coord.long_delta_min, coord.long_delta_sec, data.supp_data);
